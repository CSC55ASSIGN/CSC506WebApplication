...
<!-- side nav css file -->
<link href='csss/SidebarNav.min.css' media='all' rel='stylesheet' type='text/css'/>
<!-- //side nav css file -->
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="#"><span class="fa fa-area-chart"></span> MAZZYTECH<span class="dashboard_text">User Dashboard</span></a></h1>
          </div>
